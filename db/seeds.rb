...
ActiveRecord::Base.transaction do
  ...
  song1 = Song.new(
    ...
    user_id: 100,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/kendrick_album1.jpg"), filename: "kendrick_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song1.mp3"), filename: "song1.mp3"}
  )
  song2 = Song.create!(
    title: "M.A.A.D City",
    description:"Good Kid, M.A.A.D City (stylized as good kid, m.A.A.d city) is the second studio album by American rapper Kendrick Lamar. It was released on October 22, 2012, by Aftermath Entertainment, Interscope Records, and Top Dawg Entertainment. The album is Lamar's major label debut, after his independently released first album Section.80 in 2011 and his signing to Aftermath and Interscope the following year.",
    ...
    user_id: kendrick.id,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/kendrick_album1.jpg"), filename: "kendrick_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song2.mp3"), filename: "song2.mp3"}
  )
  song3 = Song.create!(
    ...
    user_id: kendrick.id,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/kendrick_album1.jpg"), filename: "kendrick_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song3.mp3"), filename: "song3.mp3"}
  )
  song4 = Song.create!(
    ...
    user_id: kendrick.id,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/kendrick_album1.jpg"), filename: "kendrick_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song4.mp3"), filename: "song4.mp3"}
  )
  song5 = Song.create!(
    ...
    user_id: courtney.id,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/courtney_album1.jpg"), filename: "courtney_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song5.mp3"), filename: "song5.mp3"}
  )
  song6 = Song.create!(
    ...
    user_id: courtney.id,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/courtney_album1.jpg"), filename: "courtney_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song6.mp3"), filename: "song6.mp3"}
  )
  song7 = Song.create!(
    title: "Depreston",
    description:"Sometimes I Sit and Think, and Sometimes I Just Sit is the debut studio album by Australian indie rock musician Courtney Barnett, released on 20 March 2015. The album received wide acclaim and was ranked as one of the best albums of 2015 by numerous publications.",
    ...
    user_id: courtney.id,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/courtney_album1.jpg"), filename: "courtney_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song7.mp3"), filename: "song7.mp3"}
  )
  song8 = Song.create!(
    ...
    user_id: janelle.id,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/janelle_album1.jpg"), filename: "janelle_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song8.mp3"), filename: "song8.mp3"}
  )
  song9 = Song.create!(
    title: "Make Me Feel",
    description:"Monáe has given us a pop record that feels gleefully youthful, perhaps even the album she wishes she could have had as a teen in Kansas City. The songwriting is precise if not always flawless. The reckless and joyful Screwed embodies the occasional, devil-may-care nihilism experienced by queer people of color living under a surveillance state. It also contains one of the funkiest and technically impressive basslines you’ll hear on an album already in awe of Chic and George Clinton.",
    ...
    user_id: janelle.id,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/janelle_album1.jpg"), filename: "janelle_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song9.mp3"), filename: "song9.mp3"}
  )
  song10 = Song.create!(
    title: "Pynk",
    description:"Monáe has given us a pop record that feels gleefully youthful, perhaps even the album she wishes she could have had as a teen in Kansas City. The songwriting is precise if not always flawless. The reckless and joyful Screwed embodies the occasional, devil-may-care nihilism experienced by queer people of color living under a surveillance state. It also contains one of the funkiest and technically impressive basslines you’ll hear on an album already in awe of Chic and George Clinton.",
    ...
    user_id: janelle.id,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/janelle_album1.jpg"), filename: "janelle_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song10.mp3"), filename: "song10.mp3"}
  )
  song11 = Song.create!(
    title: "Let It Happen",
    ...
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/tame_impala_album1.jpg"), filename: "tame_impala_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song11.mp3"), filename: "song1.mp3"}
  )
  song12 = Song.create!(
    ...
    user_id: tame_impala.id,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/tame_impala_album1.jpg"), filename: "tame_impala_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song12.mp3"), filename: "song12.mp3"}
  )
  song13 = Song.create!(
    title: "Eventually",
    description:"Currents is the third studio album by Australian rock band Tame Impala, released on 17 July 2015 by Modular Recordings through Universal Music Australia in Australia, Fiction Records in Europe and Interscope Records in the United States. Like the group's previous two albums, Currents was written, recorded, performed, and produced by primary member Kevin Parker. For the first time, Parker also mixed the music. It was also the first time that Parker recorded all instruments by himself; the album featured no other collaborators.",
    ...
    user_id: tame_impala.id,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/tame_impala_album1.jpg"), filename: "tame_impala_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song13.mp3"), filename: "song13.mp3"}
  )
  song14 = Song.create!(
    ...
    user_id: tame_impala.id,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/tame_impala_album1.jpg"), filename: "tame_impala_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song14.mp3"), filename: "song14.mp3"}
  )
  song15 = Song.create!(
    title: "Sunday",
    ...
    user_id: earl.id,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/earl_album1.jpg"), filename: "earl_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song15.mp3"), filename: "song15.mp3"}
  )
  song16 = Song.create!(
    title: "Hive",
    description:"Doris is the debut studio album by American rapper Earl Sweatshirt. It was released on August 20, 2013, by Columbia Records, Odd Future Records and Tan Cressida Records. Doris follows his first mixtape Earl, which was released in 2010 when he was sixteen. After returning from a forced stay in a Samoan boarding school, he began working on his debut album and signed a deal with Columbia, rather than Odd Future's Odd Future Records.",
    ...
    user_id: earl.id,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/earl_album1.jpg"), filename: "earl_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song16.mp3"), filename: "song16.mp3"}
  )
  song17 = Song.create!(
    title: "Chum",
    description:"Doris is the debut studio album by American rapper Earl Sweatshirt. It was released on August 20, 2013, by Columbia Records, Odd Future Records and Tan Cressida Records. Doris follows his first mixtape Earl, which was released in 2010 when he was sixteen. After returning from a forced stay in a Samoan boarding school, he began working on his debut album and signed a deal with Columbia, rather than Odd Future's Odd Future Records.",
    ...
    user_id: earl.id,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/earl_album1.jpg"), filename: "earl_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song17.mp3"), filename: "song17.mp3"}
  )
  song18 = Song.create!(
    title: "Whoah",
    description:"Doris is the debut studio album by American rapper Earl Sweatshirt. It was released on August 20, 2013, by Columbia Records, Odd Future Records and Tan Cressida Records. Doris follows his first mixtape Earl, which was released in 2010 when he was sixteen. After returning from a forced stay in a Samoan boarding school, he began working on his debut album and signed a deal with Columbia, rather than Odd Future's Odd Future Records.",
    ...
    user_id: earl.id,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/earl_album1.jpg"), filename: "earl_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song18.mp3"), filename: "song18.mp3"}
  )
  song19 = Song.create!(
    title: "Hoarse",
    description:"Doris is the debut studio album by American rapper Earl Sweatshirt. It was released on August 20, 2013, by Columbia Records, Odd Future Records and Tan Cressida Records. Doris follows his first mixtape Earl, which was released in 2010 when he was sixteen. After returning from a forced stay in a Samoan boarding school, he began working on his debut album and signed a deal with Columbia, rather than Odd Future's Odd Future Records.",
    ...
    user_id: earl.id,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/earl_album1.jpg"), filename: "earl_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song19.mp3"), filename: "song19.mp3"}
  )
  song20 = Song.create!(
    title: "Knight",
    description:"Doris is the debut studio album by American rapper Earl Sweatshirt. It was released on August 20, 2013, by Columbia Records, Odd Future Records and Tan Cressida Records. Doris follows his first mixtape Earl, which was released in 2010 when he was sixteen. After returning from a forced stay in a Samoan boarding school, he began working on his debut album and signed a deal with Columbia, rather than Odd Future's Odd Future Records.",
    ...
    user_id: earl.id,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/earl_album1.jpg"), filename: "earl_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song20.mp3"), filename: "song20.mp3"}
  )
  song21 = Song.create!(
    ...
    user_id: louis.id,
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song21.mp3"), filename: "song21.mp3"}
  )
  song22 = Song.create!(
    title: "Jam Sesh",
    genre:"other",
    release_date:"03/03/2019",
    user_id: louis.id,
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song22.mp3"), filename: "song22.mp3"}
  )
  song23 = Song.create!(
    title: "Rough Draft",
    ...
    release_date:"03/03/2019",
    user_id: louis.id,
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song23.mp3"), filename: "song23.mp3"}
    )
  song24 = Song.create!(
    title: "Afloat",
    genre:"jazz",
    ...
    user_id: jacob.id,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/jacob_album1.jpg"), filename: "jacob_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song24.mp3"), filename: "song24.mp3"}
  )
  song25 = Song.create!(
    ...
    user_id: jacob.id,
    image: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/jacob_album1.jpg"), filename: "jacob_album1.jpg"},
    song_file: {io: File.open("/Users/louisleon/desktop/sound_crowd_seed_assets/song25.mp3"), filename: "song25.mp3"}
  )
end