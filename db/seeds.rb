...
when "development"
  ...
  ActiveRecord::Base.transaction do
    ...
    song5 = Song.create!(
      ...
      user_id: courtney.id,
      image: {io: open("https://s3-us-west-1.amazonaws.com/sound-crowd-dev/courtney_album1.mp3"), filename: "courtney_album1.jpg"},
...
when "production"
  ...
  ActiveRecord::Base.transaction do
    ...
    song5 = Song.create!(
      ...
      release_date:"15/03/2015",
      user_id: courtney.id,
      image: {io: open("https://s3-us-west-1.amazonaws.com/sound-crowd-dev/courtney_album_1.mp3"), filename: "courtney_album1.jpg"},
      song_file: {io: open("https://s3-us-west-1.amazonaws.com/sound-crowd-dev/song5.mp3"), filename: "song5.mp3"}
    )
    song6 = Song.create!(
      title: "Pedestrian at best",
